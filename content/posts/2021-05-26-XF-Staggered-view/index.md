...
We use a data service to retrieve an amount of pictures for a given artist, this results in a List of strings that are all URL's pointing to some pictures online. When then use regular find and replace to inject that list of into the above provided HTML.
